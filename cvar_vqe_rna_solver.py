...
if __name__ == "__main__":
    ...
    seq_10 = "GGUGCCGAAC"
    # Deterministic 15 nt sequence, generated the same way as
    # scaling_analysis_real.py for consistency across the project.
    seq_15 = generate_test_sequence(15, seed=15)

    results = [
        evaluate_sequence(seq_10, "10 nt sequence"),
        evaluate_sequence(seq_15, "15 nt sequence"),
    ]
